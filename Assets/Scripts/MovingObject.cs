...
public class MovingObject : MonoBehaviour
{
    ...
    private Quaternion currentNodeStartRotation = Quaternion.identity;
    ...
    void FixedUpdate()
    {
        if (isMoving && currentNode != null)
        {
            ...
            rigidbody.Move(
                Vector3.Lerp(currentNodeStartPosition, currentNode.transform.position, currentCurveValue),
                Quaternion.Lerp(currentNodeStartRotation, currentNode.transform.localRotation, currentCurveValue)
            );
    ...
    private void RecordCurrentStartValues()
    {
        ...
        currentNodeStartRotation = transform.localRotation;
